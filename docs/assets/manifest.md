...
T09 used only code-authored Phaser primitives and CSS. T27 V2 adds original AI-assisted SVG office textures (direction A). T29 has approval to incorporate one Pixabay office ambience recording, but acquisition is blocked and the recording is not yet present in the product.
...
| T29 office ambience “Quiet room ambience with traffic outside” (planned; 2:00 MP3 per official page metadata; not yet acquired) | AntonLD, Pixabay sound-effect page 120009; source approved by user 2026-09-26. Official page describes Pixabay Content License; preserve page, verify full terms, and record SHA-256 after acquisition. Do not redistribute standalone. | Approved for in-game background use only; not yet bundled or enabled | Planned: `apps/web/src/audio/assets/office-quiet-traffic.mp3`; import through Vite after official source file is obtained |
