...
- In headed movement journeys, choose targets inside reachable floor, not exactly on a collider boundary; account for the player radius and per-frame movement when setting tolerances.
